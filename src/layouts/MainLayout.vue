<template>
  <q-layout view="lHh Lpr lFf">
    <q-header elevated>
      <q-toolbar>
        ...
        <q-toolbar-title class="text-h6">
          Dashboard Mobilità Sostenibile
        </q-toolbar-title>
        <q-space />
        <div class="q-gutter-sm row items-center no-wrap">
          ...
          <q-btn round flat>
            <q-avatar size="26px">
              <img src="https://via.placeholder.com/150?text=U" />
              <!-- TOKEN PER BIT.LY c961e3914fd9674b62b2ad27086a7ed0d288edb4 -->
            </q-avatar>
          </q-btn>
        </div>
      </q-toolbar>
    ...
    >
      <div class="q-mb-xl">
        <div class="text-white text-bold q-px-md q-mt-md">
          Menu
        </div>
      </div>
      <q-list separator v-for="(link, index) in menuLinks" :key="index">
        <essential-link
          :title="link.title"
  ...
  data() {
    return {
      ...
      menuLinks: [
        {
          title: "Dashboard",
          caption: "Il riepilogo della tua azienda",
          link: "/Dashboard1",
          icon: "fas fa-columns"
        },
        {
          title: "Questionari",
          caption: "Compila un nuovo questionario",
          link: "/questionari",
          icon: "far fa-clipboard"
        },
        {
          title: "Profilo Aziendale",
          caption: "Modifica il tuo profilo aziendale",
          link: "/Azienda",
          icon: "fas fa-building"
        },
        {
          title: "Assistenza",
          caption: "Richiedi assistenza tecnica",
          link: "/assistenza",
          icon: "far fa-question-circle"
        },
        {
          title: "Esci",
          caption: "Esci dall'account",
          link: "/login",
